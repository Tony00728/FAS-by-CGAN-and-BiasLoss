...
tf.flags.DEFINE_string('checkpoint_dir', 'checkpoints/20230901-1702', 'checkpoints/20230901-1702')
tf.flags.DEFINE_string('XtoY_model', 'young2old(51+vgg16).pb', 'XtoY model name, default: man2woman.pb')
tf.flags.DEFINE_string('YtoX_model', 'old2young(30vgg16).pb', 'YtoX model name, default: woman2man.pb')
