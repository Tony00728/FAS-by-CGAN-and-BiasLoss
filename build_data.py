...
tf.flags.DEFINE_string('X_input_dir', '/home/tony/MORPH/30-',
                       'X input directory, default: datasets/gray2comic/gray')
tf.flags.DEFINE_string('Y_input_dir', '/home/tony/MORPH/51+',
                       'Y input directory, default: datasets/gray2comic/comic')
tf.flags.DEFINE_string('X_output_file', '/home/tony/MORPH/30-.tfrecords',
                       'X output tfrecords file, default: datasets/gray2comic/gray.tfrecords')
tf.flags.DEFINE_string('Y_output_file', '/home/tony/MORPH/51+.tfrecords',
                       'Y output tfrecords file, default: datasets/gray2comic/comic.tfrecords')
